        ...
        <MDBRow className="justify-content-center align-items-center h-100">
          <MDBCol md="12" xl="4" className='pic'>
            ...
            <MDBCardBody className="text-center ">
              ...
              <MDBTypography tag="h5" style={{ opacity: 0.8 }}> <button onClick={() => handletab1()} className="btn-1">About</button> </MDBTypography>
              <MDBTypography tag="h5" style={{ opacity: 0.8 }}> <button onClick={() => handletab()} className="btn-2" >Blog</button></MDBTypography>
